...
This repository publishes compact guidance for Rust coding agents. [llms.txt](llms.txt) is the core and chapter router. Keep reusable Rust advice there or in the relevant chapter rather than duplicating it in tool-specific instructions.
...
- Keep chapter paths stable; update internal links when headings change. Avoid duplicating example source in prose. Keep examples small, compiled, and representative of the stated invariant.
