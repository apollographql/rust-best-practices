...
Green gates ≠ correct behavior. Report what ran, what failed, what's unverified; separate pre-existing failures from regressions. Review the final diff for behavior changes, invariant gaps, dep fit, test strength; don't restate compiler diagnostics as review findings.
